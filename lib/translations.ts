...
export const translations = {
  es: {
    ...
    subtitle: 'Construí este portfolio de punta a punta. La mejor forma que encontré de mostrar lo que hago.',
    availableForWork: 'Open to work',
    searchPlaceholder: 'Hacé tu pregunta...',
    searchPlaceholderMobile: 'Hacé tu pregunta...',
  ...
  en: {
    ...
    subtitle: 'I built this portfolio from end to end. The best way I found to show what I do.',
    availableForWork: 'Open to work',
    searchPlaceholder: 'Ask your question...',
    searchPlaceholderMobile: 'Ask your question...',
